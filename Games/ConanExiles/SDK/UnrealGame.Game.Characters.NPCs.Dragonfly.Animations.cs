...
namespace ConanExilesGame.Game.Characters.NPCs.Dragonfly.Animations
{
	/// <summary>
	/// UAB_Dragonfly_C:UAB_Master_Quadropeds_C
	/// Size: 0x14E0
	/// Properties: 1
	/// </summary>
	public class UAB_Dragonfly_C:UAB_Master_Quadropeds_C
	{
