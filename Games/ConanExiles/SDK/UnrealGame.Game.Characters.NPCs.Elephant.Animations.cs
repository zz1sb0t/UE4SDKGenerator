...
namespace ConanExilesGame.Game.Characters.NPCs.Elephant.Animations
{
	/// <summary>
	/// UAB_Elephant_C:UAB_Master_Quadropeds_C
	/// Size: 0x14E0
	/// Properties: 1
	/// </summary>
	public class UAB_Elephant_C:UAB_Master_Quadropeds_C
	{
