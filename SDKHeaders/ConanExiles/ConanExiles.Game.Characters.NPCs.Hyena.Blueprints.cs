...
using ConanExiles.Game.Systems.AI;
using ConanExiles.Game.Characters.NPCs.Hyena.Blueprints;


namespace ConanExiles.Game.Characters.NPCs.Hyena.Blueprints
{
	/// <summary>
	/// ABP_NPC_Wildlife_Hyena_C:ABaseBPWildlife_C
	/// Size: 0x1188
	/// Properties: 15
	/// </summary>
	public class ABP_NPC_Wildlife_Hyena_C:ABaseBPWildlife_C
	{
		...
		/// Size: 0x08
		/// </summary>
		public UBP_CharacterAttackPoint_C AttackPoint_Back => ReadUObject<UBP_CharacterAttackPoint_C>(0x1128);
		...
		/// Size: 0x08
		/// </summary>
		public UBP_CharacterAttackPoint_C AttackPoint_Front => ReadUObject<UBP_CharacterAttackPoint_C>(0x1130);
	...
	/// <summary>
	/// ABP_NPC_Wildlife_HyenaSpotted_C:ABP_NPC_Wildlife_Hyena_C
	/// Size: 0x1190
	/// Properties: 1
	/// </summary>
	public class ABP_NPC_Wildlife_HyenaSpotted_C:ABP_NPC_Wildlife_Hyena_C
	{
		...
		/// Size: 0x08
		/// </summary>
		public FPointerToUberGraphFrame UberGraphFrame => ReadStruct<FPointerToUberGraphFrame>(0x1188);
		
	}


	/// <summary>
	/// ABP_NPC_Wildlife_HyenaStriped_C:ABP_NPC_Wildlife_Hyena_C
	/// Size: 0x1190
	/// Properties: 1
	/// </summary>
	public class ABP_NPC_Wildlife_HyenaStriped_C:ABP_NPC_Wildlife_Hyena_C
	{
		public override int ObjectSize => 4496;
		/// <summary>
		/// Name: UberGraphFrame
	...
	/// <summary>
	/// ABP_NPC_Wildlife_HyenaUndead_C:ABP_NPC_Wildlife_Hyena_C
	/// Size: 0x1190
	/// Properties: 1
	/// </summary>
	public class ABP_NPC_Wildlife_HyenaUndead_C:ABP_NPC_Wildlife_Hyena_C
	{
		public override int ObjectSize => 4496;
		/// <summary>
		/// Name: UberGraphFrame
	...
	/// <summary>
	/// ABP_NPC_Wildlife_Zoo_HyenaUndead_C:ABP_NPC_Wildlife_HyenaUndead_C
	/// Size: 0x1190
	/// Properties: 0
	/// </summary>
	public class ABP_NPC_Wildlife_Zoo_HyenaUndead_C:ABP_NPC_Wildlife_HyenaUndead_C
	{
		public override int ObjectSize => 4496;
	}
