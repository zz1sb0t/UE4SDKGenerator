...
using ConanExiles.Game.Characters.NPCs.Serpent_people_skeleton.Blueprints;


namespace ConanExiles.Game.Characters.NPCs.Serpent_people_skeleton.Blueprints
{
	/// <summary>
