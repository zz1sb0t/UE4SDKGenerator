...
using ConanExiles.Game.Characters.Emotes;
using ConanExiles.Game.Systems.Progression;
using ConanExiles.Game.Systems.Buffs;
using ConanExiles.Game.Systems.Combat;
using ConanExiles.Game.Systems.Religion;
using ConanExiles.Game.Items.Weapons.AnimPackage;
using ConanExiles.Game.Systems.Inventory;
using ConanExiles.Game.Systems.Building.BuildingActorComponents;
using ConanExiles.Game.Systems;
using ConanExiles.Game.Systems.Components;
using ConanExiles.Game.Systems.Thrall;
using ConanExiles.Game.Items.LoreObjects;
using ConanExiles.Game.Systems.Building;
using ConanExiles.Game.Effects.blueprints;
using ConanExiles.Game.Environment.Sandstorm;
using ConanExiles.Game.Systems.Hunger;
using ConanExiles.Game.Systems.Building.SplinePlaceables;
using ConanExiles.Game.Systems.Survival.Gathering;
using ConanExiles.Game.Systems.Combat.EncumbranceSystem;
using ConanExiles.Game.Effects.Particles;
using ConanExiles.Game.Systems.Loot.TableSetup;
using ConanExiles.Game.Systems.Survival.Gathering.Gathering_v2;


namespace ConanExiles.Game.Characters
{
	/// <summary>
