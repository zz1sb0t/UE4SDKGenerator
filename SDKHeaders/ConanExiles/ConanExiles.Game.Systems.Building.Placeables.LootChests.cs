...
using ConanExiles.Game.Systems.Camps;
...
using ConanExiles.Game.Items.Inventory;
using ConanExiles.Game.Systems.Building.Placeables.LootChests;


namespace ConanExiles.Game.Systems.Building.Placeables.LootChests
{
	/// <summary>
