...
namespace ConanExilesGame.Game.Characters.NPCs.Ostrich.Animations
{
	/// <summary>
	/// UAB_Ostrich_C:UAB_Master_Quadropeds_C
	/// Size: 0x14E0
	/// Properties: 1
	/// </summary>
	public class UAB_Ostrich_C:UAB_Master_Quadropeds_C
	{
