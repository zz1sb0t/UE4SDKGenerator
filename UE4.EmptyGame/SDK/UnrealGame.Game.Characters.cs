...
using UnrealGame.Game.Characters.Emotes;
using UnrealGame.Game.Systems.Progression;
using UnrealGame.Game.Systems.Buffs;
using UnrealGame.Game.Systems.Combat;
using UnrealGame.Game.Systems.Religion;
using UnrealGame.Game.Items.Weapons.AnimPackage;
using UnrealGame.Game.Systems.Inventory;
using UnrealGame.Game.Systems.Building.BuildingActorComponents;
using UnrealGame.Game.Systems;
using UnrealGame.Game.Systems.Components;
using UnrealGame.Game.Systems.Thrall;
using UnrealGame.Game.Items.LoreObjects;
using UnrealGame.Game.Systems.Building;
using UnrealGame.Game.Effects.blueprints;
using UnrealGame.Game.Environment.Sandstorm;
using UnrealGame.Game.Systems.Hunger;
using UnrealGame.Game.Systems.Building.SplinePlaceables;
using UnrealGame.Game.Systems.Survival.Gathering;
using UnrealGame.Game.Systems.Combat.EncumbranceSystem;
using UnrealGame.Game.Effects.Particles;
using UnrealGame.Game.Systems.Loot.TableSetup;
using UnrealGame.Game.Systems.Survival.Gathering.Gathering_v2;


namespace UnrealGame.Game.Characters
{
	/// <summary>
