...
using UnrealGame.Game.Systems.Camps;
...
using UnrealGame.Game.Items.Inventory;
using UnrealGame.Game.Systems.Building.Placeables.LootChests;


namespace UnrealGame.Game.Systems.Building.Placeables.LootChests
{
	/// <summary>
